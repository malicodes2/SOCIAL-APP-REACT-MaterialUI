...
const Navbar = () => {
    ...
    return (
        <AppBar position="sticky"><StyledToolBar>
            <Typography variant="h6" sx={{ display: { xs: "none", sm: "block" } }}>BE SOCIAL</Typography>
            ...
            <Icons>
                ...
                <Avatar sx={{ width: 30, height: 30 }} src='https://images.pexels.com/photos/846742/pexels-photo-846742.jpeg'
